...
for(int j=size;j<=end;j+=((end-size)/10))
{
  double sh_max=0,sh_min=999999,sh_avg=0;
double in_max=0,in_min=999999,in_avg=0;
 long long sh_steps=0,in_steps=0;
  ...
  for(int i=0;i<test_times;i++)
    ...
    cout<<"---------------------------------------------------------------\n";
    cout<<"shell     MAX= "<<sh_max<<" :: shell      MIN= "<<sh_min<<"  AVERAGE: "<<sh_avg<<" steps: "<<sh_steps<<endl;
    cout<<"insertion MAX= "<<in_max<<" :: insertion  MIN= "<<in_min<<"  AVERAGE: "<<in_avg<<" steps: "<<in_steps<<endl;
    cout<<"efectivness insertion steps/sec : "<<sh_steps/sh_avg<<endl;
    cout<<"efectivness shell     steps/sec : "<<in_steps/in_avg<<endl;
